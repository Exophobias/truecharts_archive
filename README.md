...
- ### Changelog:
	- 2024.12.09 @ 06:02 PM PST:
		- Stable:
			...
			- changedetection-io: v0.48.01 --> v0.47.06
			...
			- prowlarr: v1.28.0.4862  --> v1.28.0.4862
			...
			- readarr: v0.4.5.2699 --> v0.4.4.2686
			- redis: v7.2.5 --> v7.4.1
			...
			- solr: v9.6.0 --> v9.7.0
			- sonarr: v4.0.11.2680 --> v4.0.10.2544
