...
- ### Changelog:
	- 2025.06.01 @ 12:58 PM PDT:
		- Stable:
			...
			- clickhouse: v25.4.3.22 --> v25.5.1.2782
			...
			- drawio: v27.0.2 --> v27.0.9
			- emby: v4.9.0.53 --> v4.9.1.0
			...
			- flexget: v3.15.40 --> v3.16.0
			- flowise: v2.2.8 --> v3.0.0
			- ghostfolio: v2.161.0 --> v2.163.0
			- gitea: v1.23.7 --> v1.23.8
			- gravity: v0.26.5 --> v0.27.0
			- healthchecks: v3.10.20250512 --> v3.10.20250526
			- home-assistant: v2025.5.1 --> v2025.5.3
			- homebridge: v2025.2.26 --> v2025.5.27
			- homer: v25.05.1 --> v25.05.2
			- immich: v1.132.3 --> v1.134.0
			- ipfs: v0.34.1 --> v0.35.0
			- jackett: v0.22.1891 --> v0.22.1971
			- jenkins: v2.509.0 --> v2.512.0
			- jupyter: v2025.5.12 --> v2025.5.30
	...
	- 2025.02.19 @ 08:57 PM PST:
		- Stable:
			...
			- clickhouse: v25.1.2.3 --> v25.1.4.53
